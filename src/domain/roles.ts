...
// 10-14: bộ vai cơ bản · 15-19: thêm Hoàng tử, Bị nguyền · 20+: tất cả các vai.
...
export const DEFAULT_ROLES: Role[] = [
  ...
  role('seer', 'Tiên tri', '🔮', 'villager', 'Soi một người mỗi đêm. Sói đầu đàn không bị phát hiện là Sói.', 'Chọn một người để soi.', {
